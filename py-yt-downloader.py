...
class YT_Downloader(ctk.CTk):
    def __init__(self):
        ...
        video_file_extension = ctk.CTkEntry(master=tab.tab("Video"), width=350, height=40, placeholder_text="File Extension: mp4, mkv etc...")
        ...
        # Video Current directory
        video_current_directory_label = ctk.CTkLabel(master=tab.tab("Video"), text=f"Current Directory: {os.getcwd()}")
        video_current_directory_label.pack(padx=10, pady=10)
        ...
        # Audio Current directory
        audio_current_directory_label = ctk.CTkLabel(master=tab.tab("Audio"), text=f"Current Directory: {os.getcwd()}")
        audio_current_directory_label.pack(padx=10, pady=10)
